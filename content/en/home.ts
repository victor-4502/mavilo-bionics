...
const en: HomeContent = {
  ...
  product: {
    eyebrow: "MAV 1",
    title: "Meet the hand.",
    body: "A myoelectric prosthesis with coordinated opening and closing. Technical polymers, mechanical pivots, and contact pads — a physical device, not a promise.",
    traits: [
      "Myoelectric control",
  ...
  movement: {
    eyebrow: "Movement",
    title: "From intention to gesture.",
    body: "A calibrated signal becomes controlled mechanical motion — predictable opening and closing.",
  ...
  about: {
    ...
    body: "MAVILO Bionics develops prosthetic technology: mechanical engineering, electronics, and software focused on human mobility.",
  },
  cta: {
    title: "Let's talk.",
    body: "Meet MAVILO Bionics and MAV 1.",
    primary: "Contact MAVILO",
    secondary: "Back to MAV 1",
