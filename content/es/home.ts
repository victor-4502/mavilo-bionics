...
const es: HomeContent = {
  ...
  product: {
    eyebrow: "MAV 1",
    title: "Conocer la mano.",
    body: "Prótesis mioeléctrica con apertura y cierre coordinados. Polímeros técnicos, pivotes mecánicos y pads de contacto — un dispositivo físico, no una promesa.",
    traits: [
  ...
  movement: {
    eyebrow: "Movimiento",
    title: "De la intención al gesto.",
    body: "La señal calibrada se traduce en un movimiento mecánico controlado — apertura y cierre predecibles.",
  ...
  about: {
    ...
    body: "MAVILO Bionics desarrolla tecnología protésica: ingeniería mecánica, electrónica y software orientados a la movilidad humana.",
  },
  cta: {
    title: "Hablemos.",
    body: "Conoce MAVILO Bionics y MAV 1.",
    primary: "Contactar a MAVILO",
    secondary: "Volver a MAV 1",
